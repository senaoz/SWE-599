...
export default function LoginPage({ onLogin }: Props) {
  ...
  return (
    <section className="grid min-h-screen bg-primary lg:grid-cols-2">
      ...
      {/* Right column */}
      <figure
        className="relative hidden flex-1 flex-col items-start justify-end gap-6 overflow-hidden rounded-l-[80px] p-14 lg:flex"
        style={{
          background:
            "linear-gradient(135deg, #3b1f7a 0%, #53389E 40%, #6941C6 100%)",
        }}
      >
        <img
          src="/login-bg.jpg"
        ...
        />
        <div className="pointer-events-none absolute inset-0 bg-linear-to-t from-black/50 from-20% to-transparent to-90%" />
      </figure>
    </section>
  );
}
