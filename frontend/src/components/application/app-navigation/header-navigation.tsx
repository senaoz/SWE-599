    ...
    <>
      ...
      <header className="max-lg:hidden">
        ...
        >
          <div
            className={cx(
              "flex w-full max-w-container items-center pr-3 pl-4 md:px-8",
              centered && "gap-8",
            )}
          >
            <div
        ...
        {showSecondaryNav && (
          <section
            className={cx(
              "flex w-full items-center justify-center bg-primary",
          ...
          >
            {secondaryType === "tabs" ? (
              ...
              <div
                className={cx(
                  "flex h-16 w-full max-w-container items-center gap-8 px-8",
